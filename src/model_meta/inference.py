...
model_path = "/home/takeru/AlphaSymbol/logs/2025-0109-1522-26/lightning_logs/version_0/checkpoints/epoch=313-step=3768.ckpt"
data_module_path = (
    "/home/takeru/AlphaSymbol/logs/2025-0109-1522-26/data_module.pkl"
)
...
with torch.no_grad():
    for gen_token_idx in range(1, data_module.tgt_input_size):
        src_input_list = [
            data_module.src_pad_point(
                data_module.src_add_ends([*x, y]), data_module.point_vector_size
            )
        ...
        tgt_token_list = data_module.tgt_pad(
            tgt_token_list, data_module.tgt_input_size
        )
